...
public class MemberDAO {
	...
	public ArrayList<MemberVO> selectAllCommunityKing() {
		ArrayList<MemberVO> datas = new ArrayList<MemberVO>(); // 실행 결과 담을 MemberVO 타입 배열리스트 datas 생성
		conn = JDBCUtil.connect(); // JDBCUtil 연결
		try {
	...
	/*
	 * // 테스트용 public static void main(String[] args) { MemberDAO mdao = new
	 * MemberDAO(); MemberVO mvo = new MemberVO(); mvo.setId("hwan");
	 * mvo.setmPw("1234");
	 * 
