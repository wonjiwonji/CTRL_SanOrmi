      ...
      <div class="center">
        ...
        <form action="updateQNA.do">
          ...
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="subject	" placeholder="제목을 입력하세요" name="qTitle" value="${vqvo.qTitle}" required />
          </div>
          <div class="mb-3 mt-3">
            <label for="content">내용:</label>
            <textarea class="form-control" rows="5" id="content" placeholder="내용을 입력하세요" name="qContent">${vqvo.qContent }</textarea>
          </div>
          <input type="hidden" value="${vqvo.qNum }" class="form-control" id="name" name="qNum"/>
