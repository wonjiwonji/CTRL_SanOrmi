...
<body class="bg-gradient-success">
	...
	<div class="container">
                         ...
                         class="form-control form-control-user" placeholder="주소"> -->
                              ...
                              id="exampleInputDAdress" placeholder="상세주소" required /> -->
								...
								<a href="javascript:kakaoLogin();"
									...
									class="fab fa-google fa-fw"></i> 카카오로 회원가입
								</a>

								<script src="https://developers.kakao.com/sdk/js/kakao.js"></script>
								<script>  window.Kakao.init('0596558f916b43386fdee6f4cfee3b54');

        function kakaoLogin() {
            window.Kakao.Auth.login({
                scope: 'account_email , age_range', //동의항목 페이지에 있는 개인정보 보호 테이블의 활성화된 ID값을 넣습니다.
                ...
                fail: function(error) {
                    console.log(error);
								...
								<a onclick="naverLogout(); return false;"
									id="naverIdLogin_loginButton" href="javascript:void(0)"
									class="btn btn-facebook btn-user btn-block"> 네이버으로 회원가입 </a>
		...
		{
			clientId: "d7jG1IHGM3go47lJrKGw", //내 애플리케이션 정보에 cliendId를 입력해줍니다.
			callbackUrl: "http://localhost:8080/ctrl/login.html", // 내 애플리케이션 API설정의 Callback URL 을 입력해줍니다.
			isPopup: false,
			callbackHandle: true
		}
	);	
	...
	setTimeout(function() {
		closePopUp();
                           ...
                           <a class="small" href="forgot-password.html">비밀번호 찾기</a>
								...
								<div class="text-center">
									<a class="small" href="login.html">이미 회원이신가요? 로그인으로 이동!</a>
								</div>
							</div>
						</div>
					</div>
