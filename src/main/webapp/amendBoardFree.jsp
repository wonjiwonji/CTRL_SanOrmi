			...
			<form action="updateBoard.do">
				<div>
					<label for="name">작성자:</label> <input type="text"
						value="${sessionScope.id }" class="form-control" id="name"
						name="bId" readonly required />
				</div>
				<div class="mb-3 mt-3">
					<label for="subject">제목:</label> <input type="text"
						class="form-control" id="subject	" placeholder="제목을 입력하세요"
						name="bTitle" value="${vbvo.bTitle}" required />
				</div>
				<div class="mb-3 mt-3">
					<label for="content">내용:</label>
					<textarea class="form-control" rows="5" id="content"
						placeholder="내용을 입력하세요" name="bContent">${vbvo.bContent }</textarea>
				</div>
				<input type="hidden" value="${vbvo.bNum }" class="form-control"
					id="name" name="bNum" />
