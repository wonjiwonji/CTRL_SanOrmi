      ...
      <div class="center">
        ...
        <form action="updateBoard.do">
          ...
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="subject	" placeholder="제목을 입력하세요" name="bTitle" value="${vbvo.bTitle}" required />
          </div>
          <div class="mb-3 mt-3">
            <label for="content">내용:</label>
            <textarea class="form-control" rows="5" id="content" placeholder="내용을 입력하세요" name="bContent">${vbvo.bContent }</textarea>
          </div>
          <input type="hidden" value="${vbvo.bNum }" class="form-control" id="name" name="bNum"/>
